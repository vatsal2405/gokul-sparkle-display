(function () {
  ...
  var DEFAULT_PRODUCTS = [
    ...
    { id: "p5", name: "Symphony 70L Desert Air Cooler", cat: "Coolers", mrp: 17990, price: 8990, desc: "Powerful blower, honeycomb pads and ice chamber for hot days.", img: IMG + "photo-1608303588026-884930af2559?auto=format&fit=crop&w=800&q=70" },
    { id: "p6", name: "Bajaj 36L Personal Air Cooler", cat: "Coolers", mrp: 9990, price: 5490, desc: "Slim, low power draw and easy to shift between rooms.", img: IMG + "photo-1567016526105-22da7c13161a?auto=format&fit=crop&w=800&q=70" },
    ...
    { id: "p10", name: "Wall Mount Bracket & HDMI Kit", cat: "Accessories", mrp: 2490, price: 1245, desc: "Universal TV bracket with 3m high-speed HDMI cable.", img: IMG + "photo-1588508065123-287b28e013da?auto=format&fit=crop&w=800&q=70" },
    { id: "p11", name: "Voltas 1.5 Ton Window AC", cat: "Accessories", mrp: 36990, price: 27990, desc: "Fast cooling, copper condenser and turbo mode.", img: IMG + "photo-1596704017254-9b121068fb31?auto=format&fit=crop&w=800&q=70" },
